...
int main(int, char **) {
  ...
  float window_rouding = 0.0f;
  float window_border_size = 0.0f;
  ImVec2 window_padding{0.0f, 0.0f};
...
#endif
  {
    ...
    // 0. Enable Dockspace mode
    // const ImGuiViewport *viewport = ImGui::GetMainViewport();
    // ImGui::SetNextWindowPos(viewport->WorkPos);
    // ImGui::SetNextWindowSize(viewport->WorkSize);
    // ImGui::SetNextWindowViewport(viewport->ID);
    // ImGui::PushStyleVar(ImGuiStyleVar_WindowRounding, window_rouding);
    ...
    //   ImGui::PopStyleVar();
    // }
    // // this corrsponds to WindowRounding and WindowBorderSize settings
    // ImGui::PopStyleVar(2);
    ...
    // to create a named window.
    {
      ...
      ImGui::SliderFloat("window rounding", &window_rouding, 0.0f, 10.0f);
      ImGui::SliderFloat("window border size ", &window_border_size, 0.0f,
                         10.0f);
      ImGui::SliderFloat2("window padding",
                          reinterpret_cast<float *>(&window_padding), 0.0f,
                          10.0f);
      ImGui::ColorEdit3(
          "clear color",
